...
const App: React.FC = () => {
  ...
  const renderView = () =>
    activeView === "assistant"
      ? <VideoAssistant token={token} />
      : <PerformanceAnalyzer token={token} />;

  const HeaderLink = ({ view, label }: { view: ActiveView; label: string }) => (
    <button
  ...
  return (
    <div className="min-h-screen bg-base-100 text-base-content font-sans">
      <header className="sticky top-0 bg-base-200/80 backdrop-blur-md shadow-lg">
